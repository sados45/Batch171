...
public class Lambda03 {
    public static void main(String[] args) {
        ...
        System.out.println(getSumEvensBetweenTwoInt(13, 7));
    ...
    public static int getSumEvensBetweenTwoInt(int a, int b) {
    ...
    // 2. Yol
    public static int getSumEvensBetweenTwoInt2(int a, int b) {
